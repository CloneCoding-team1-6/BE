...
import com.sparta.cloneslack.repository.ImageRepository;
...
//        DeleteObjectRequest request = new DeleteObjectRequest(hellcording, fileName);
//        amazonS3Client.deleteObject(request);
//    }

    // S3로 업로드
    private String putS3(File uploadFile, String fileName) {
        amazonS3Client.putObject(new PutObjectRequest(hellcording, fileName, uploadFile).withCannedAcl(CannedAccessControlList.PublicRead));
        return amazonS3Client.getUrl(hellcording, fileName).toString();
    }
